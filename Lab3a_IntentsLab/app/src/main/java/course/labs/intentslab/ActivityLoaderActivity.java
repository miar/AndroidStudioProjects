...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
		...
		// TODO -> OK - Create a base intent for viewing a URL -> ok
		// (HINT:  second parameter uses Uri.parse())
		Intent baseIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(URL));

		// TODO -> OK - Create a chooser intent, for choosing which Activity
		...
		// TODO -> OK - Start the chooser Activity, using the chooser intent
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		// TODO -> OK - Process the result only if this method received both a
