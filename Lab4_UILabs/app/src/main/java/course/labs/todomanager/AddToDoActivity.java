	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO - OK Indicate result and finish
		...
		// TODO - OK ? Set up OnClickListener for the Reset Button
		final Button resetButton = (Button) findViewById(R.id.resetButton);
		resetButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {

				// TODO - OK Reset data to default values
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO - OK Get the current Priority
				Priority priority = null;
				priority = getPriority();

				// TODO - OK Get the current Status
				Status status = null;
				status = getStatus();
				// TODO - OK Get the current ToDoItem Title
				...
				// TODO - OK return data Intent and finish
